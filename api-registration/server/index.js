...
app.post('/api/auth/sign-up', (req, res, next) => {
  ...
  returning *
  `;
  const argPass = result;
  const params = [username, argPass];
    db.query(sql, params).then(returnResult=>{
      const [returnValue] = returnResult.rows;
      console.log('returnResult HHHHHHHH', returnResult.rows)
